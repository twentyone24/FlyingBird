...
namespace SkyFlightGame
{
    ...
    public class SFGRing : MonoBehaviour
    {
        ...
        [Tooltip("Apply the speed boost every nth ring Move Speed")]
        public int speedBoostEvery = 5;
        internal int ringCount = 0;

        [Tooltip("How many rings we must pass before the speed boost starts adding to the player Move Speed")]
        public int delaySpeedBoost = 30;
        ...
        void Update()
        {
            ...
            if (playerObject)
            {
                ...
                {
                    // If the player passes through a rung
